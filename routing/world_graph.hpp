...
public:
  ...
  virtual RouteWeight CalcLeapWeight(ms::LatLon const & from, m2::PointD const & to) const = 0;
  virtual RouteWeight CalcLeapWeight(m2::PointD const & from, ms::LatLon const & to) const = 0;
