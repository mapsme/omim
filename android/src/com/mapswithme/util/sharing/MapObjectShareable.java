...
public class MapObjectShareable extends BaseShareable
{
  ...
  public MapObjectShareable(Activity context, MapObject mapObject)
  {
    ...
    final int textId = mMapObject.isMyPosition() ? R.string.my_position_share_email
                                                 : R.string.bookmark_share_email;
    final int subjectId = mMapObject.isMyPosition() ? R.string.my_position_share_email_subject
