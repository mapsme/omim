...
public class MapObject implements Parcelable
{
  ...
  {
    this(mapObjectType, name, lat, lon, typeName, new Metadata());
  }

  public MapObject(@MapObjectType int mapObjectType, String name, double lat, double lon, String typeName, Metadata metadata)
  {
