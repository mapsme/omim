...
jobject CreateMapObject(JNIEnv * env, place_page::Info const & info)
{
  ...
  if (info.IsBookmark())
  {
    ...
    static jmethodID const ctorId = jni::GetConstructorID(
        env, g_bookmarkClazz,
        "(Lcom/mapswithme/maps/bookmarks/data/FeatureId;IILjava/lang/String;Ljava/"
    ...
    jobject mapObject = env->NewObject(
        g_bookmarkClazz, ctorId, jFeatureId.get(), static_cast<jint>(info.m_bac.m_categoryIndex),
        static_cast<jint>(info.m_bac.m_bookmarkIndex), jName.get(), jTitle.get(),
        jSecondaryTitle.get(), jbanners.get(), jTaxiTypes.get(), jBookingSearchUrl.get(),
