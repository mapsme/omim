...
prebuild_static_libs := osrm protobuf tomcrypt jansson bzip2 zlib fribidi freetype expat base coding geometry platform indexer storage search routing drape drape_frontend map stats_client succinct
...
LOCAL_STATIC_LIBRARIES := map drape_frontend routing search storage indexer drape platform geometry coding base expat freetype fribidi zlib bzip2 jansson tomcrypt protobuf osrm stats_client succinct
...
LOCAL_SRC_FILES := \
	...
	com/mapswithme/maps/settings/StoragePathManager.cpp \
