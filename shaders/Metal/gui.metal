                               ...
                               constant Uniforms_T & uniforms [[buffer(1)]])
{
  ...
  half4 color = (half4)u_colorTex.sample(u_colorTexSampler, in.a_texCoords);
...
TextOutlinedGuiFragment_T ComputeTextOutlinedGuiVertex(constant Uniforms_T & uniforms, float3 a_position, float2 a_normal,
                                                       ...
                                                       float2 a_maskTexCoord, texture2d<float> u_colorTex,
                                                       sampler u_colorTexSampler)
{
  ...
  out.glyphColor = (half4)u_colorTex.sample(u_colorTexSampler,
