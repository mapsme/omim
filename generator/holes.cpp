...
namespace generator
{
HolesAccumulator::HolesAccumulator(cache::IntermediateDataReader & cache) : m_merger(cache) {}
...
HolesRelation::HolesRelation(cache::IntermediateDataReader & cache) : m_holes(cache), m_outer(cache)
{
}
