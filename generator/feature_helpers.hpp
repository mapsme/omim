...
public:
  ...
  using MinDrawableScalePolicy = int (*)(TypesHolder const & types, m2::RectD limitRect);

  CalculateMidPoints(MinDrawableScalePolicy minDrawableScalePolicy = GetMinDrawableScale);
