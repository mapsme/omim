...
UNIT_TEST(CityRoadsGenerationTest_Empty) { TestCityRoadsBuilding(vector<uint64_t>({})); }

UNIT_TEST(CityRoadsGenerationTest_FromZero) { TestCityRoadsBuilding(vector<uint64_t>({0, 1, 10})); }
...
{
  TestCityRoadsBuilding(vector<uint64_t>({75000, 75001, 75004, 250000, 250001, 330003, 330007}));
}
...
{
  TestCityRoadsBuilding(vector<uint64_t>({1000,  1203,  1,     11004, 11,    11009, 11010, 1011,
                                          11012, 11013, 4,     11015, 11016, 11017, 11018, 11019,
                                          11020, 11021, 11022, 11023, 11024, 11025, 2}));
}
