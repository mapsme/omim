...
{
  char const * arr[][2] = {{"abutters", "residential"},
                           {"highway", "primary"},
...
{
  char const * arr1[][2] = {
      {"highway", "primary"}, {"motorroad", "yes"}, {"name", "Каширское шоссе"}, {"oneway", "yes"}};

  char const * arr2[][2] = {
      {"highway", "primary"}, {"name", "Каширское шоссе"}, {"oneway", "-1"}, {"motorroad", "yes"}};

  char const * arr3[][2] = {
      {"admin_level", "4"}, {"border_type", "state"}, {"boundary", "administrative"}};

  char const * arr4[][2] = {
      {"border_type", "state"}, {"admin_level", "4"}, {"boundary", "administrative"}};
...
{
  char const * arr[][2] = {{"addr:housenumber", "84"},
...
{
  char const * arr[][2] = {{"addr:conscriptionnumber", "223"}, {"addr:housenumber", "223/5"},
                           {"addr:postcode", "11000"},         {"addr:street", "Řetězová"},
                           {"addr:streetnumber", "5"},         {"source:addr", "uir_adr"},
...
{
  char const * arr[][2] = {{"alt_name:vi", "California"},
                           {"is_in", "USA"},
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_AlabamaRiver)
{
  ...
  char const * arr2[][2] = {{"destination", "Ohio River"},
                            {"name", "Tennessee River"},
                            {"type", "waterway"},
                            {"waterway", "river"}};

  char const * arr3[][2] = {{"name", "Tennessee River"},
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_Synonyms)
{
  ...
  {
    char const * arr[][2] = {
        {"building", "yes"}, {"shop", "yes"},       {"atm", "yes"},
        {"toilets", "yes"},  {"restaurant", "yes"}, {"hotel", "yes"},
    };
  ...
  // Duplicating test.
  {
    char const * arr[][2] = {{"amenity", "atm"}, {"atm", "yes"}};
  ...
  // "NO" tag test.
  {
    char const * arr[][2] = {{"building", "yes"}, {"shop", "no"}, {"atm", "no"}};
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_Capital)
{
  ...
  {
    char const * arr[][2] = {
        {"place", "city"}, {"admin_level", "4"}, {"boundary", "administrative"},
        {"capital", "2"},  {"place", "city"},
    };
...
{
  {
    char const * arr[][2] = {{"highway", "motorway"}, {"ref", "I 95"}};
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_Hwtag)
{
  char const * tags[][2] = {
      ...
      {"hwtag", "yesfoot"}, {"hwtag", "yesbicycle"}, {"hwtag", "bidir_bicycle"}};
...

  {
    char const * arr[][2] = {
        ...
        {"foot", "no"},   {"bicycle", "yes"},     {"oneway:bicycle", "no"},
    };
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_Subway)
{
  ...
  {
    char const * arr[][2] = {
        {"name", "S Landsberger Allee"},       {"phone", "030 29743333"},
        {"public_transport", "stop_position"}, {"railway", "station"},
        {"network", "New York City Subway"},   {"station", "light_rail"},
    };
