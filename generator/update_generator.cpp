...
namespace update
{
  ...
  */
  ...
  // @TODO(@syershov) This method generates countries.txt. Now countries.txt
  // is generated by a script. Let's remove all the funtionality for courntries.txt generating
  // form C++ code.
  bool UpdateCountries(string const & dataDir)
  {
    ...
    string jsonBuffer;
    {
      ...
      countries.ForEachDescendants(sizeUpdater);
    }
