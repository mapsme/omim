...
final class PhotosInteractionAnimator: NSObject {
  ...
  @objc var animator: UIViewControllerAnimatedTransitioning?
  @objc var viewToHideWhenBeginningTransition: UIView?
  @objc var shouldAnimateUsingAnimator = false

  fileprivate var transitionContext: UIViewControllerContextTransitioning?

  @objc func handlePanWithPanGestureRecognizer(_ gestureRecognizer: UIPanGestureRecognizer, viewToPan: UIView, anchorPoint: CGPoint) {
