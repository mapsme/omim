...
- (void)addBookmark
{
  ...
  size_t const bookmarkIndex = f.GetBookmarkManager().AddBookmark(categoryIndex, listener.userMark->GetPivot(), data);
  ...
  listener.userMark = guard.m_controller.GetUserMark(bookmarkIndex);
