...
{
  return [UIColor colorWithRed:scaled(255) green:scaled(48) blue:scaled(52) alpha:1];
}
...
{
  return [UIColor colorWithRed:scaled(220) green:scaled(0) blue:scaled(57) alpha:1];
}
