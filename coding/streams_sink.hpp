...
namespace stream
{
  ...
  public:
    ...
    template <typename T>
    typename std::enable_if<std::is_integral<T>::value, SinkReaderStream &>::type
    operator >> (T & t)
    {
    ...
    SinkReaderStream & operator >> (std::string & t)
    {
  ...
  public:
    ...
    template <typename T>
    typename std::enable_if<std::is_integral<T>::value, SinkWriterStream &>::type
    operator << (T const & t)
    {
