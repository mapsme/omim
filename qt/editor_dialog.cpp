  ...
  : QDialog(parent), m_feature(emo)
{
  ...
  {  // Feature types.
    ...
    std::string localized = m_feature.GetLocalizedType();
    ...
    case osm::Props::Internet:
      {
        ...
        QComboBox * cmb = new QComboBox();
        std::string const values[] = {DebugPrint(osm::Internet::Unknown), DebugPrint(osm::Internet::Wlan),
