...
UNIT_TEST(AreaOnEarth_Convex_Polygon_1)
{
  ...
  TEST(base::AlmostEqualRel(areaTriangulated,
                            ms::ApproximatePolygonAreaOnEarth(points),
                            1e-6), (areaTriangulated, ms::ApproximatePolygonAreaOnEarth(points)));
}
