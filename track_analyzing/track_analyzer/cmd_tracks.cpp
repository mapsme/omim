...
{
public:
  void AddUsers(size_t numUsers)
  {
    m_numUsers += numUsers;
  }

  void AddTracks(size_t numTracks)
  {
    m_numTracks += numTracks;
  }

  void AddPoints(size_t numPoints)
  {
               ...
               bool noMwmLogs, bool noWorldLogs)
{
  ...
  auto processMwm = [&](string const & mwmName, UserToMatchedTracks const & userToMatchedTracks) {
    ...
    mwmStats.AddUsers(userToMatchedTracks.size());
