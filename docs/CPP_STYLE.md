...
- Order of directories in includes: "current_dir/current_file.hpp", includes from other dirs sorted by dependencies (e.g. indexer, then coding, then base. Please see https://docs.google.com/drawings/d/1WHF4-Ia1WcrAp_39bBK9jL8YDr-RKbc2t7w6XOfLFqw/edit?usp=sharing for details.), "defines.hpp", "private.h", C++ standard library headers, boost headers, 3party. If dirs don't depend on each other they may be written in any order. All subdirs of a dir should be grouped together.
