...
UNIT_TEST(IsUrlSupportedTest)
{
  ...
  TEST(downloader::IsUrlSupported("mac/991215/Luna.mwm"), ());
  TEST(downloader::IsUrlSupported("mac/0/Luna.mwm"), ());
  TEST(!downloader::IsUrlSupported("mac/x/Luna.mwm"), ());
  TEST(!downloader::IsUrlSupported("macarena/0/Luna.mwm"), ());
  TEST(!downloader::IsUrlSupported("/hack/mac/0/Luna.mwm"), ());
  TEST(!downloader::IsUrlSupported("0/Luna.mwm"), ());
  TEST(!downloader::IsUrlSupported("mac/0/Luna"), ());
  TEST(!downloader::IsUrlSupported("0/Luna.mwm"), ());
  ...
  TEST(!downloader::IsUrlSupported("mac/diffs/0/0/Luna.mwmdiff"), ());
