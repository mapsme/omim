...
UNIT_TEST(CountryFile_Smoke)
{
  ...
  TEST_EQUAL("TestCountry" DATA_FILE_EXTENSION, countryFile.GetNameWithTwoComponentsExt(MapOptions::Map), ());
  TEST_EQUAL("TestCountry" DATA_FILE_EXTENSION ROUTING_FILE_EXTENSION,
             countryFile.GetNameWithTwoComponentsExt(MapOptions::CarRouting), ());
