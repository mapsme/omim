...
UNIT_TEST(CountryFile_Smoke)
{
  ...
  TEST_EQUAL("TestCountry" DATA_FILE_EXTENSION, GetNameWithTwoComponentsExt(countryFile.GetName(),
                                                                            MapOptions::Map), ());
  TEST_EQUAL("TestCountry" DATA_FILE_EXTENSION ROUTING_FILE_EXTENSION,
             GetNameWithTwoComponentsExt(countryFile.GetName(), MapOptions::CarRouting), ());
