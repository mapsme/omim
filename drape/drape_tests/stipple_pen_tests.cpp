...
UNIT_TEST(StippleMappingTest)
{
  ...
  EXPECTGL(glTexImage2D(512, 8, gl_const::GLRed, gl_const::GL8BitOnChannel, NULL));
  ...
  EXPECTGL(glTexSubImage2D(0, 0, 256, 6, gl_const::GLRed, gl_const::GL8BitOnChannel, _))
      .WillOnce(Invoke(&cmp, &MemoryComparer::cmpSubImage));

  DummyTexture texture;
  texture.Create(width, height, dp::RED);
  ...
  EXPECTGL(glTexSubImage2D(0, 6, 256, 2, gl_const::GLRed, gl_const::GL8BitOnChannel, _))
  ...
  EXPECTGL(glTexSubImage2D(256, 0, 256, 2, gl_const::GLRed, gl_const::GL8BitOnChannel, _))
