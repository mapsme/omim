...
public:
  ...
  /// \returns children node ids (country id) by a parent for downloaded mwms.
  ...
  /// \note. This method returns only real maps which have been written in coutries.txt. It means
  /// the method does not return neither custmom maps generated by user nor World.mwm and WorldCoasts.mwm.
  vector<TCountryId> GetDownloadedChildren(TCountryId const & parent) const;
