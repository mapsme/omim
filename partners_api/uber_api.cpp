...
#define UBER_SERVER_TOKEN "wiOmT0UeRMsf-F9paRaNUX_fN5wgoUInzMnT3BMD"
#define UBER_CLIENT_ID "cTsLRQ3TmxGv7LdPmY7V7y6laXq3EWGh"
                                ...
                                ProductsCallback const & fn)
{
  ...
  ResetThread();
  m_runFlag = true;
  m_thread = make_unique<threads::SimpleThread>(GetAvailableProductsAsync, ref(from), ref(to),
