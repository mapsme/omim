...
def main():
    ...
    def get_countries_list_from_line(line):
      countries = []
      used_countries = set()
      countries_list = []
    ...
    countries = set(get_countries_list_from_line(countries_line))
    without_countries = set(get_countries_list_from_line(without_countries_line))
