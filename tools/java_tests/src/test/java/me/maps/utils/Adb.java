...
public class Adb {
	...
	private static String adbLs(String dir) throws Exception {
		return shell(String.format("ls %s", dir));
	}


	public static void startApp() throws Exception {
		shell("am start -n com.mapswithme.maps.pro/com.mapswithme.maps.DownloadResourcesActivity");
	}
	...
	public static void adbUninstall(String name) throws Exception {
		adb(String.format("uninstall %s", name));
	}


	private static void adbPush(String what, String where) throws Exception {
		String filename = Paths.get(what).getFileName().toString();
		push(what, where, filename);
		// fonts.obb/mnt/sdcard/Android/obb/com.mapswithme.maps.pro/fonts.obb
		// adb push world.obb
	...
	private static List<String> adbDevices() throws Exception {
