...
files=(copyright.html faq.html resources-default resources-ldpi resources-mdpi resources-hdpi resources-xhdpi resources-xxhdpi categories.txt classificator.txt
       ...
       drules_proto.bin drules_proto_dark.bin drules_proto_clear.bin city_rank.txt external_resources.txt packed_polygons.bin countries.txt sound-strings colors.txt patterns.txt)
