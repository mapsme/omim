                                            ...
                                            float depth, TextViewParams & params) const
{
  ...
  titleDecl.m_primaryOptional = primaryProto->has_is_optional() ? primaryProto->is_optional()
                                                                : true;
  ...
  if (secondaryProto)
  {
    ...
    titleDecl.m_secondaryOptional = secondaryProto->has_is_optional() ? secondaryProto->is_optional()
                                                                      : true;
  }
}
