...
{
  return GetScreen(currentScreen, std::bind(&AnimationSystem::GetProperty, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3), screen);
}

void AnimationSystem::GetTargetScreen(ScreenBase const & currentScreen, ScreenBase & screen)
{
  GetScreen(currentScreen, std::bind(&AnimationSystem::GetTargetProperty, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3), screen);
}
...
void AnimationSystem::PushAnimation(drape_ptr<Animation> && animation)
{
  ...
  std::shared_ptr<TAnimationList> pList(new TAnimationList());
...
void AnimationSystem::FinishAnimations(Animation::Type type, std::string const & customType, bool rewind, bool finishAll)
{
