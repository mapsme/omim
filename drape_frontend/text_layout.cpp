...
public:
  ...
  void operator() (dp::TextureManager::GlyphRegion const & glyph)
  {
    ...
    m_buffer.push_back(gpu::TextStaticVertex(m_colorCoord, m_outlineCoord, glsl::ToVec2(mask.LeftTop())));
    m_buffer.push_back(gpu::TextStaticVertex(m_colorCoord, m_outlineCoord, glsl::ToVec2(mask.LeftBottom())));
    m_buffer.push_back(gpu::TextStaticVertex(m_colorCoord, m_outlineCoord, glsl::ToVec2(mask.RightTop())));
    m_buffer.push_back(gpu::TextStaticVertex(m_colorCoord, m_outlineCoord, glsl::ToVec2(mask.RightBottom())));
  }
...
{
  TextGeometryGenerator gen(colorRegion, outlineRegion, staticBuffer);
